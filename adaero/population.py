...
from adaero.models.user import User
from adaero.models import find_external_managers
...
def generate_population_csv_from_business_unit(ldapsource, unit_name):
    ...
    Parameters
    ----------
    ldapsource: `adaero.security.ldapauth.LDAPAuth`
    unit_name: `str`
...
def generate_required_users(ldapsource, rows, messages):
    """
    Generate valid `adaero.models.user.User` object that have manager
    ...
    Returns
    -------
    List of generated `adaero.models.user.User` objects and error
    messages.
    """
